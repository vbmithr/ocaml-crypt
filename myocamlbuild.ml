(* OASIS_START *)
(* DO NOT EDIT (digest: da734209fcab46313caf8dbb60253b2c) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("crypt", ["lib"])];
     lib_c = [("crypt", "lib", [])];
     flags =
       [
          (["oasis_library_crypt_cclib"; "link"],
            [(OASISExpr.EBool true, S [A "-cclib"; A "-lcrypt"])]);
          (["oasis_library_crypt_cclib"; "ocamlmklib"; "c"],
