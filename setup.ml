...
(* OASIS_START *)
(* DO NOT EDIT (digest: cfb10f793f036936d37d6c43cd3f3970) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "crypt"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\226\233\025%\002\149>\200f\139-\200\233\134\255\011";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
